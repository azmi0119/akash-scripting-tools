                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                ...
                                <h5 class="font-weight-bolder">Dashboard Dashboard</h5>
                                <p class="mb-5">Kick start your Laravel Project with Dashboard, this include - User
                                    Management, Roles & Permission Functionality, Charts and Built in components.</p>
